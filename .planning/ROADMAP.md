...
- [x] 02-01-PLAN.md — Define deterministic engine lifecycle/outcome primitives, including core HP and structure build-radius semantics.
- [x] 02-02-PLAN.md — Enforce authoritative server lifecycle transitions, breach-finish outcomes, restart guards, and defeat lockout rejections.
...
- [ ] 04-01-PLAN.md — Add engine-authoritative affordability metadata, income breakdown fields, and pending queue projection contracts.
...
| 4. Economy HUD & Queue Visibility       | 0/3            | Not started | -          |
