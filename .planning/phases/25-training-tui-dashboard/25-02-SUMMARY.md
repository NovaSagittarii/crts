...
tech-stack:
  added: []
  patterns: [ink-testing-library render/lastFrame for component testing, useStdout for terminal width, useInput for keyboard handling, ref-based batched rendering]
