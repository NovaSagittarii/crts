...
plan: 02
subsystem: server
tags: [broadcast-suppression, input-only, lockstep, transport-protocol, ring-buffer]
...
tech-stack:
  added: []
  patterns: [isInputOnlyMode guard pattern for broadcast suppression, ring buffer lifecycle (create/populate/discard/clear)]
