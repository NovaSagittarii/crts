# Requirements Archive: v0.0.1 Prototype Baseline

**Archived:** 2026-03-01
**Status:** SHIPPED

This file is a historical snapshot for v0.0.1.
Define fresh milestone requirements with `/gsd-new-milestone` (which recreates `.planning/REQUIREMENTS.md`).
...
- Milestone closure requirement accounting uses 16 tracked v1 requirements.
- `LOBBY-02` remains a delivered capability, but is excluded from requirement accounting per milestone-closure decision.

## v1 Requirements

Requirements for initial release. Each tracked item maps to roadmap phases.
...
### Delivered but Excluded from Requirement Accounting
...
- v1 tracked requirements: 16 total
- Mapped to phases: 16
- Unmapped: 0 ✓
